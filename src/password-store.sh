...
cmd_jot() {
	...
	SIZE=$(du -sm "$PREFIX" | awk '{print $1}')
	printf " \033[0;32m[✔]\033[0m \033[35m $current_time entry added!\033[0m \033[38;5;208m(Total Entries: $count)\033[0m \033[90m($SIZE MB)\033[0m \n"
